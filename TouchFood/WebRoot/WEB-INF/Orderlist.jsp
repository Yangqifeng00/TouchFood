...
<html>
	...
	<body data-spy="scroll" data-target=".navbar-fixed-top" class="index-page">
				...
				<% 	}else{ %>
					<li class="login_ul">
						...
						<ul class="login_ul_li">
							...
							<li style="font-size:15px;"><a href="/TouchFood/jspController/register.do">购物车</a></li>
			...
			<div class="table-responsive"  >
				<table class="table" style="margin: 20px 0 20px 0;">
					...
					<tbody>
						...
						<c:forEach items="${orderlists}" var="orderlist" varStatus="st">
							<tr aos="fade-down">
								<td class="buyCar-img" style="width: 150px;"><img src="../${orderlist.smImg}" /></td>
								<td style="line-height: 60px;">${orderlist.name}</td>
								<td style="line-height: 60px;">${orderlist.price}</td>
								<td style="line-height: 60px;">${orderlist.num}</td>
								<td style="line-height: 60px;">${orderlist.couprice}</td>
		...
		<script type="text/javascript">
			function orderlist(){
				$.ajax({
					url:"/TouchFood/orderlist/Findorderlist"
			    });
			}
		</script>
