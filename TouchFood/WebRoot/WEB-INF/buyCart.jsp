...
<html>
	...
	<body data-spy="scroll" data-target=".navbar-fixed-top" class="index-page">
				...
				<table class="table" style="margin: 20px 0 20px 0;">
					...
					<tbody>
						...
						<c:forEach items="${ois}" var="oi" varStatus="st">
							<tr aos="fade-down">
								...
								<td style="line-height: 60px;"><a href="/TouchFood/orderlist/delete?pid=${oi.commodity.id}">删除</a></td>
							</tr>
						</c:forEach>
					...
					<c:if test="${!empty ois}">
						<tr>
							...
							<form action="/TouchFood/order/insertlist" method="post" id="ordersubmit">
							<input type="hidden" id="uaddress" value=<%=session.getAttribute("uaddress")%> />
								<button type="button" onclick="create()">提交订单</button>
							</form>
		...
		<script type="text/javascript">
			var flag1 = false;
			$(function(){
				var uaddress = document.getElementById("uaddress").value.trim();
